...
def cell_to_hex(walls_state: int) -> str:
    """Convert walls_state bitmask to a single hex character.

    Args:
        walls_state: Bitmask using cell.py constants.

    Returns:
        Single uppercase hex character.
    """
...
class MazeSolver:
    ...
    def __init__(self, maze: Maze) -> None:
        ...
        Args:
            maze: A Maze instance that has already been generated.
        """
        self.maze = maze
    ...
    def _open_neighbors(
        ...
        """Return passable neighbors from a cell.
        ...
        Returns:
            List of (direction, neighbor_row, neighbor_col).
        """
    ...
    def shortest_path(self) -> Optional[List[str]]:
        ...
        Returns:
            List of direction letters or None if no path exists.
        """
    ...
    def _rebuild_path(
        ...
        Args:
            came_from: Dict mapping each coord to (previous_coord, direction).
            start: Starting coordinate.
            end: Ending coordinate.

        Returns:
            Ordered list of direction letters.
        """
        path: List[str] = []
        current = end
        while current != start:
...
def display_ascii(
    ...
    """Print the maze as coloured ASCII art in the terminal.

    Args:
        maze: Generated Maze instance.
        path: Solution path as list of direction letters.
...
def export_hex(maze: Maze, path: List[str], filename: str) -> None:
    """Write the maze in hex format + metadata to a file.

    Args:
        maze: Generated Maze instance.
        path: Shortest path as list of direction letters.
...
def menu(maze: Maze, path: Optional[List[str]], filename: str) -> None:
    """Display interactive terminal menu for the maze.

    Args:
        maze: Current Maze instance.
        path: Current shortest path (may be None).
